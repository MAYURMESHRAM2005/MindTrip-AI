    ...
    <div className="card animate-slide-up p-8 text-center">
      ...
      {state === 'success' && (
        <>
          ...
          <h1 className="mt-4 text-xl font-extrabold text-slate-900 dark:text-white">Email verified!</h1>
      ...
      {state === 'error' && (
        <>
          ...
          <h1 className="mt-4 text-xl font-extrabold text-slate-900 dark:text-white">Verification failed</h1>
